...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if msg.header.seq % 50 == 0:
            ...
            coordinate = Circular(pi/60.0,2.25,1.5,msg.pose.position.x,msg.pose.position.y,msg.pose.position.z)
            # coordinate = Circular(pi/2,2.25,1.5,msg.pose.position.x,msg.pose.position.y,msg.pose.position.z)
